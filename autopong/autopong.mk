...
ProjectPath            :=/home/tom/Documents/WORK/MachineOrientedProgramming/autopong
...
PostBuild:
	...
	$(GccArmDir)/bin/arm-none-eabi-objcopy -S -O srec  ./Debug/autopong.elf ./Debug/autopong.s19
	$(GccArmDir)/bin/arm-none-eabi-objdump -D -S ./Debug/autopong.elf > ./Debug/autopong.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c $(IntermediateDirectory)/startup.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/tom/Documents/WORK/MachineOrientedProgramming/autopong/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
