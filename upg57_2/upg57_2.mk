...
PostBuild:
	...
	$(GccArmDir)/bin/arm-none-eabi-objcopy -S -O srec  ./Debug/upg57_2.elf ./Debug/upg57_2.s19
	$(GccArmDir)/bin/arm-none-eabi-objdump -D -S ./Debug/upg57_2.elf > ./Debug/upg57_2.dass
	@echo Done
