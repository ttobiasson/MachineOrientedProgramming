...
##
## Debug
ProjectName            :=autopong_keypad
ConfigurationName      :=Debug
WorkspacePath          :=/home/tom/Documents/WORK/MachineOrientedProgramming
ProjectPath            :=/home/tom/Documents/WORK/MachineOrientedProgramming/autopong_keypad
...
ObjectsFileList        :="autopong_keypad.txt"
PCHCompileFlags        :=
...
PostBuild:
	...
	$(GccArmDir)/bin/arm-none-eabi-objcopy -S -O srec  ./Debug/autopong_keypad.elf ./Debug/autopong_keypad.s19
	$(GccArmDir)/bin/arm-none-eabi-objdump -D -S ./Debug/autopong_keypad.elf > ./Debug/autopong_keypad.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c $(IntermediateDirectory)/startup.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/tom/Documents/WORK/MachineOrientedProgramming/autopong_keypad/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
